															...
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort" v-for="dto in list.dto"><!--注意这里的for循环嵌套   -->
																		<dt><span v-bind:title="dto.catalogName">{{dto.catalogName}}</span></dt><!--注意这里的vue的v-bind的赋值-->
																	</dl>
																</div>
															</div>
														</div>
		...
		<div  v-for="(flowx,index) in Flow"><!-- 注意这里的id和v-for的位置关系以及index的作用是数组中的i -->
			...
			<div class="am-g am-g-fixed floodOne ">
				<div class="am-u-sm-5 am-u-md-3 am-u-lg-4 text-one " >
					...
					<img height="280px" width="280px" v-bind:src="'http://192.168.111.128/'+flowx.dto[0].pictureName" /></a>
					<!-- <a href="# "><img height="205px" width="324px" v-bind:src="'http://192.168.111.128/'+flowx.dto[0].pictureName" /></a> -->
				</div>
			<!-- </div>
		</div> -->
			...
			<div class="am-u-sm-7 am-u-md-5 am-u-lg-4">
					<div class="text-two">
						...
						<a href="# "><img height="280px" width="280px" v-bind:src="'http://192.168.111.128/'+flowx.dto[1].pictureName" /></a>
					</div>
					<div class="text-two last">
						...
						<a href="# "><img height="280px" width="280px"  v-bind:src="'http://192.168.111.128/'+flowx.dto[2].pictureName" /></a>
					</div>
				</div>
				<div class="am-u-sm-12 am-u-md-4 ">
					<div class="am-u-sm-3 am-u-md-6 text-three">
						...
						<a href="# "><img height="180px" width="180px"  v-bind:src="'http://192.168.111.128/'+flowx.dto[3].pictureName" /></a>
					</div>
					...
					<div class="am-u-sm-3 am-u-md-6 text-three">
						...
						<a href="# "><img height="180px" width="180px" v-bind:src="'http://192.168.111.128/'+flowx.dto[4].pictureName" /></a>
					</div>
					...
					<div class="am-u-sm-3 am-u-md-6 text-three">
						...
						<<a href="# "><img height="180px" width="180px" v-bind:src="'http://192.168.111.128/'+flowx.dto[5].pictureName" /></a>
					</div>
					...
					<div class="am-u-sm-3 am-u-md-6 text-three">
						...
						<<a href="# "><img height="180px" width="180px" v-bind:src="'http://192.168.111.128/'+flowx.dto[6].pictureName" /></a><!-- 注意这里的图片地址格式 -->
					</div>
					...
					<!-- <div class="am-u-sm-3 am-u-md-6 text-three last ">
						...
						<<a href="# "><img height="130px" width="130px" v-bind:src="'http://192.168.111.128/'+flowx.dto[6].pictureName" /></a>注意图片地址格式 
					</div> -->
				</div>
			</div>
			<div class="clear "></div>
		...
		<div v-if="index % 3 == 1">	
			...
			<div class="am-g am-g-fixed floodTwo ">
				...
				<div class="am-u-sm-5 am-u-md-4 text-one ">
					...
					<a href="# "><img  v-bind:src="'/book-img/'+flowx.dto[0].pictureName" />	</div>
					</a>
				</div>
				<div class="am-u-sm-7 am-u-md-4 am-u-lg-2 text-two">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[1].pictureName" /></a>
				</div>
				...
				<div class="am-u-md-4 am-u-lg-2 text-three">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[2].pictureName" /></a>
				</div>
				<div class="am-u-md-4 am-u-lg-2 text-three">
					<div class="outer-con ">
						<div class="title ">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[3].pictureName" /></a>
				</div>
				<div class="am-u-sm-6 am-u-md-4 am-u-lg-2 text-two ">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[4].pictureName" /></a>
				</div>
				<div class="am-u-sm-6 am-u-md-3 am-u-lg-2 text-four ">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[5].pictureName" /></a>
				</div>
				<div class="am-u-sm-4 am-u-md-3 am-u-lg-4 text-five">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[6].pictureName" /></a>
				</div>
				<div class="am-u-sm-4 am-u-md-3 am-u-lg-2 text-six">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[7].pictureName" /></a>
				</div>
				<div class="am-u-sm-4 am-u-md-3 am-u-lg-4 text-five">
					<div class="outer-con ">
						<div class="title ">
					...
					<a href="# "><img  v-bind:src="'http://192.168.111.128/'+flowx.dto[8].pictureName" /></a><!-- 注意这里图片是放在linux上的用ngiux地址为服务器的地址 -->
				</div>
			</div>
			...
			<div class="am-g am-g-fixed flood method3 ">
					<ul class="am-thumbnails ">
						<li v-for="dto2 in flowx.dto">
							<div class="list ">
								<a href="# ">
									<img  v-bind:src="'http://192.168.111.128/'+dto2.pictureName" />
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
			  ...
			  function scrollLoad() {
			        ...
			        if ((top + win) >= doc) {
			        	Lazyload();
			          //  $(document.body).append('<img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1376798474,2656130210&fm=27&gp=0.jpg">     <img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1376798474,2656130210&fm=27&gp=0.jpg">   <img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1376798474,2656130210&fm=27&gp=0.jpg">');
			        }
			    }
			...
			function bookList(){
				$.post('/catalog/book.do',{},Bookback);
			}
			
			function Bookback(ajaxDAO,status){
				
				if(ajaxDAO.success){
					var books = ajaxDAO.data;
					List.Flow = books;
				}
			...
			/* 	function parent(){
				...
				function Parentback (ajaxDAO,status){
					if(ajaxDAO.success){
						parentCatalogArray=ajaxDAO.data;
					}
				}
				 */
				/* function Lazyload(){
					if (parentCatalogArray.length == 0) {
					 ...
					 var catalogName=parentCatalogArray.shift();
					var param={
